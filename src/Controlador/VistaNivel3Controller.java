...
public class VistaNivel3Controller {
    ...
    int[] resultado = Operacion.RestaN3();
    int [] aleatorio = Operacion.aleatorio();
    
    int[] resultado1 = Operacion.RestaN3();
    int [] aleatorio1 = Operacion.aleatorio();
    
    int[] resultado2 = Operacion.RestaN3();
    int [] aleatorio2 = Operacion.aleatorio();
    
    int[] resultado3 = Operacion.RestaN3();
    ...
    void Fil2Carta1(MouseEvent event) {
        ...
        if (nunCarta1 == valCartaSup && valCartaSup == resul) {
	        ...
	        // Se incrementa puntos acumulado +10	    
	        acumtotal += 10;
	        // Se incrementa puntos de nivel +10	    
	        ptosNivel += 10;
	        //Se suman puntos de nivel con acumulado
	        ptosAvan +=10;
	        ...
	        String acumN = Integer.toString(acumtotal);
	        String ptosN = Integer.toString(ptosNivel);
	        String avnzN = Integer.toString(ptosAvan);
	        
	        puntos.set(0, acumN); // Actualizar el valor de "Acumulado" en la lista
	        puntos.set(1, ptosN); // Actualizar el valor de "puntosnivel" en la lista
	        puntos.set(2, avnzN); // Actualizar el valor de "puntosnivel" en la lista
	        ...
	        //Se accede a al array puntos y se actualizan los puntos de nivel y acumulado
	        String ptoAcuN = (puntos.get(0));
	        String ptoNivStr = (puntos.get(1));
	        String avanz = (puntos.get(2));

            puntosNivel1.setText(ptoNivStr);
            totAcumulado.setText(ptoAcuN);
            
	        System.out.println("Valor acumulado para avanzar " + avanz);//prueba
        	...
        	if (ptosAvan==40) {
        		alertaGeneral.showAlert("Nivel Alcanzado", "Ahora puedes ver el top de puntos");
	        ...
	        // Se decrementa puntos acumulado -10	    
	        acumtotal -= 10;
	        // Se decrementa puntos de nivel -10	    
	        ptosNivel -= 10;
    ...
    void btnTerminar(ActionEvent event) throws IOException {
    	...
    	if (ptosAvan ==40) {
	    	...
	    	System.out.println("Nivel alcanzado, Ahora puedes ver el top de puntos");
    	...
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/Vistaresultado.fxml"));
    	Parent root = loader.load();
    	Scene scene = new Scene(root);
    	nivelActual3.setScene(scene);
      	VistaResultadoController controller = loader.getController();
	...
	public void init(String text, String text2, String text3, Stage nivelActual2,
			VistaNivel2Controller vistaNivel2Controller) {
		
		this.nivelActual3 = nivelActual2;
		this.obtUsuario.setText(text);
		this.labEdadn1.setText(text2);
		
		//Se toma valor acumulado nivel anterior
		int ptoAcuN1 = Integer.parseInt (text3);
     
        // Se accede a los valores de la lista "puntos"
        int ptosNivel2 = Integer.parseInt (puntos.get(1)); // Obtener el valor de "puntosnivel" de la lista
        
		// Actualizar el valor de "Acumulado" en la lista 
        String nuevAcu = Integer.toString(ptoAcuN1 + ptosNivel2);
        puntos.set(0, nuevAcu);
        
        //Se accede a la lista puntos y se asigna valor acumulado
        String ptoAcuN2 = (puntos.get(0));
		this.totAcumulado.setText(ptoAcuN2);
