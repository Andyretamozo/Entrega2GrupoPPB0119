...
public class VistaNivel1C2Controller {
    ...
    int [] aleatorio = Operacion.aleatorio3();
    
    int[] resultado1 = Operacion.resta();
    int [] aleatorio1 = Operacion.aleatorio3();
    
    int[] resultado2 = Operacion.resta();
    int [] aleatorio2 = Operacion.aleatorio3();
    
    int[] resultado3 = Operacion.resta();
    int [] aleatorio3 = Operacion.aleatorio3();
