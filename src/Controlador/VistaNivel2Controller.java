...
public class VistaNivel2Controller {
	Stage nivelActual2;
    ...
    int[] resultado = Operacion.sumaN2();
    int [] aleatorio = Operacion.aleatorio();
    
    int[] resultado1 = Operacion.sumaN2();
    int [] aleatorio1 = Operacion.aleatorio();
    
    int[] resultado2 = Operacion.sumaN2();
    int [] aleatorio2 = Operacion.aleatorio();
    
    int[] resultado3 = Operacion.sumaN2();
    ...
    void btnAvanzar(ActionEvent event) throws IOException {
    	...
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/Vista/VistaNivel3.fxml"));
    	Parent root = loader.load();
    	Scene scene = new Scene(root);
    	nivelActual2.setScene(scene);
      	VistaNivel3Controller controller = loader.getController();
    	controller.init(obtUsuario.getText(), labEdadn1.getText(), totAcumulado.getText(), nivelActual2, this);
    	nivelActual2.show();
	...
	public void init(String text, String text2, String text3, Stage nivelActual1,
			VistaNivel1Controller vistaNivel1Controller) {
		
		this.nivelActual2 = nivelActual1;
